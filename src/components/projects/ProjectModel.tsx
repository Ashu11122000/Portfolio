      ...
      >
        ...
        <div className="mb-10 flex items-start justify-between gap-6">
          <div className="flex gap-5">
            <div
              ...
              "
            >
              <FolderGit2 size={30} className="text-cyan-300" />
            </div>
        ...
        <GlassCard className="mb-8 p-6">
          ...
          <p className="mt-4 text-slate-600 dark:text-slate-400">
            ...
            software development practices, scalable architecture, responsive UI
            design, reusable components, and clean coding principles.
          </p>
        </GlassCard>
